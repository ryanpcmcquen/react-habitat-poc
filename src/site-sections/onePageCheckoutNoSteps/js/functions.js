...
function clearInfoDiv() {
	$.ajax({
		url: "/checkout/noSteps/includes/clearInfoDiv.jsp",
		type: "POST",
...
function editConfig(currEditIndex) {
	base.opc.config.form.handlers["tpl_single"]["url"] =
		"/checkout/noSteps/includes/singleShipInclude.jsp?isEditAddress=true&editListIndex=" +
		currEditIndex;
}

function resetConfig() {
	base.opc.config.form.handlers["tpl_single"]["url"] =
		"/checkout/noSteps/includes/singleShipInclude.jsp";
}
