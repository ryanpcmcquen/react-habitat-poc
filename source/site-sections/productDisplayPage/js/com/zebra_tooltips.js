					...
					(d = e(window)),
							...
							"left" == b.settings.position
								...
								: "right" == b.settings.position
									? a.element_left +
										...
										a.arrow_width
									: a.element_left +
										(a.element_width - a.tooltip_width) /
											2),
						...
						(f =
							"left" == b.settings.position
								...
								: "right" == b.settings.position
									? a.arrow_width / 2
									: (a.tooltip_width - a.arrow_width) / 2),
						d + a.tooltip_width > l + h &&
							((f -= l + h - (d + a.tooltip_width) - 6),
							(d = l + h - a.tooltip_width - 6),
							f + a.arrow_width > a.tooltip_width - 6 &&
								(f = a.tooltip_width - 6 - a.arrow_width),
							d + f + a.arrow_width / 2 < a.element_left &&
								(f = -1e4)),
						d < h &&
							((f -= h - d),
							(d = h + 2),
							0 > f && (f = a.arrow_width / 2),
							d + f + a.arrow_width / 2 >
								a.element_left + a.element_width && (f = -1e4)),
						a.arrow_container.removeClass(
							"Zebra_Tooltip_Arrow_Top"
						),
						a.arrow_container.addClass(
						...
						g < r ||
						("below" == b.settings.default_position &&
							a.element_top +
								a.element_height +
								b.settings.vertical_offset +
								a.tooltip_height +
								a.animation_offset <
								u + r)
							? ((g =
							...
							: ((a.animation_offset = -Math.abs(
								...
								(g += b.settings.vertical_offset)),
						a.arrow_container.css("left", f),
						a.tooltip.css({ left: d, top: g }),
						e.extend(a, {
							tooltip_left: d,
							tooltip_top: g,
							arrow_left: f
			...
			m = function(c) {
				...
				a.sticky ||
					...
					(a.hide_timeout = setTimeout(function() {
						if (a.tooltip) {
							if (
								b.settings.onBeforeHide &&
								"function" == typeof b.settings.onBeforeHide
							)
								b.settings.onBeforeHide(c, a.tooltip);
							a.close = !1;
							a.destroy && (a.muted = !0);
							c.data("Zebra_Tooltip", a);
							...
							a.tooltip.animate(
								...
								function() {
									...
									if (
										b.settings.onHide &&
										"function" == typeof b.settings.onHide
									)
										b.settings.onHide(c, a.tooltip);
								}
							);
						}
			...
			s = function(c) {
				...
				a.muted ||
					...
					(a.show_timeout = setTimeout(function() {
						a = n(c);
						if (
							b.settings.onBeforeShow &&
							"function" == typeof b.settings.onBeforeShow
						)
							b.settings.onBeforeShow(c, a.tooltip);
						"block" != a.tooltip.css("display") &&
							a.tooltip.css({
								top: a.tooltip_top + a.animation_offset
							});
						...
						a.tooltip.stop();
						a.tooltip.animate(
							{ top: a.tooltip_top, opacity: b.settings.opacity },
							b.settings.animation_speed,
							function() {
								if (
									b.settings.onShow &&
									"function" == typeof b.settings.onShow
								)
									b.settings.onShow(c, a.tooltip);
							}
						);
